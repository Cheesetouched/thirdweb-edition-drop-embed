...
export const processQueryParams = (params) => {
  ...
  return {
    ...
    showClaimCount: getBool("hideClaimCount", true),
    showDescription: getBool("hideDescription", true),
    showInventory: getBool("showInventory", true),
    showRemainingMints: getBool("showRemainingMints", true),
    showThirdwebLogo: getBool("hideThirdwebLogo", true),
    showTitle: getBool("hideTitle", true),
